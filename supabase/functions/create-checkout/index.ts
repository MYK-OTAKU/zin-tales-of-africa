...
serve(async (req) => {
  ...
  try {
    ...
    const priceConfig = planType === "annual" 
      ? { unit_amount: 3999, interval: "year" as const }  // 39.99€/an
      : { unit_amount: 499, interval: "month" as const }; // 4.99€/mois
      ...
      line_items: [
        {
          price_data: {
            currency: "eur",
            product_data: { 
              name: planType === "annual" ? "Zirin Premium Annuel" : "Zirin Premium Mensuel",
              description: "Accès complet à tous les contes et devinettes"
            },
